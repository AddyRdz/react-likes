...
Create a likes component in React. Your final product including stretch goals should function similarly to
...
Create a new component called **Likes**, import it into `App`, then add functionality to it so that when the component renders it records the number of clicks in state and displays the total clicks.

Your React app must compile without errors. While developing, check your browser development console for errors. If you do have errors that you cannot solve, comment them out and explain what you think is going on.

## Steps to Take

1. Use the `useState` hook to add a state variable called `totalLikes` to the component to store the current number of clicks on the component.
